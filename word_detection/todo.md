...
each image should have placed parsed text on it and rendered word's exact bounding box coordinate must be saved for that image
in YOLO26 compatible format.
3. placed text must be at most 2 different font